...
class DistanceController {
  ...
  static Future<Result<int>> getTotalDistance() async {
    ...
    final uri = Uri.https(Config.API_URL, '${Config.API_COMMON_ADDRESS}getAllDist');
  ...
  static Future<Result<int>> getPersonalDistance() async {
    ...
    final uri =
        Uri.https(Config.API_URL, '${Config.API_COMMON_ADDRESS}getUserDist', {"dosNumber": dosNumber.toString()});
